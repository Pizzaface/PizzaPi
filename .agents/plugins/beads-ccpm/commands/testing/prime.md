...
Create `.project/testing-config.md` with discovered information:
...
## Execution Rules
1. Always use the test-runner agent from `${CLAUDE_PLUGIN_ROOT}/agents/test-runner.md`
...
- Store in `.project/testing-config.md`
