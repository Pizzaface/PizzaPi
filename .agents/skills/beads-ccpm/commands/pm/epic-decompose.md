...
2. **Check for existing tasks:**
   - Check if any task files (\*.md excluding epic.md and beads-mapping.md) already exist in `.project/epics/$ARGUMENTS/`
...
- **beads_id**: Leave placeholder text - will be updated during sync
...
3. Suggest next step: "Ready to sync to Beads? Run: /pm:epic-sync $ARGUMENTS"
