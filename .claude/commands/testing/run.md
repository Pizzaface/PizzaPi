...
test -f .project/testing-config.md || echo "❌ Testing not configured. Run /testing:prime first"
```
...
Use the test-runner agent from `${CLAUDE_PLUGIN_ROOT}/agents/test-runner.md`:
