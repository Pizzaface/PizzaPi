...
echo "  /pm:epic-spr-update <name>   - Create/update stacked PRs (SPR workflow)"
echo "  /pm:epic-spr-merge <name>    - Merge stacked PRs bottom-up (SPR workflow)"
echo "  /pm:epic-merge <name>        - Traditional merge to main"
echo ""
echo "📝 Issue Commands"
...
echo "  • Epic workflow: prd-new → prd-parse → epic-decompose → epic-start"
echo "  • SPR workflow: epic-start → work → epic-spr-update → epic-spr-merge"
echo "  • Traditional workflow: epic-start → work → epic-merge"
