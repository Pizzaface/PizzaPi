...
// Extract the COMPOSE_TEMPLATE constant from web.ts at runtime by importing
// the compiled output. Since web.ts doesn't export it, we re-evaluate it here.
// This mirrors what the compiled binary will use.
