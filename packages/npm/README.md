...
A self-hosted web interface and relay server for the [pi coding agent](https://pi.dev/). Stream live AI coding sessions to any browser and interact remotely from mobile or desktop.
