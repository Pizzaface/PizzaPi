...
| `hiddenModels` | `string[]` | `[]` | Runner-local model keys (`provider/modelId`) excluded from PizzaPi model selection and agent delegation. Managed by the web Model Visibility dialog. |
