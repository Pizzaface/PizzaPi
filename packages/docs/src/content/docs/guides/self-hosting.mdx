...
4. Serves the web UI at **http://localhost:3000**
...
3. **Open the web UI**
   ...
   Navigate to **http://localhost:3000** — you'll see the PizzaPi interface.

4. **Create your account**

   The first time you visit, register an account. Then run `pizzapi setup` on your dev machine pointing to `http://localhost:3000`.
</Steps>
