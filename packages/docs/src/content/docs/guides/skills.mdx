...
Skills from global plugins (`~/.pizzapi/plugins/`, `~/.agents/plugins/`, `~/.claude/plugins/`) are automatically discovered alongside your regular skills. See the [Claude Code Plugins guide](/PizzaPi/guides/claude-plugins/) for details.
