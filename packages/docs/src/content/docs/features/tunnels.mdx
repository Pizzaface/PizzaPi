...
| Mode | When | Trade-off |
|------|------|-----------|
| **Internal CA** (default) | No DNS credentials given | Zero setup, works on a private LAN/tailnet with no inbound reachability — but every device must trust Caddy's root CA once |
