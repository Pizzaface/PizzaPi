...
This clones the repo, builds the containers, and starts the relay at **http://localhost:3000**. See [`pizza web`](/PizzaPi/guides/self-hosting/#quickest-pizza-web) for details.
